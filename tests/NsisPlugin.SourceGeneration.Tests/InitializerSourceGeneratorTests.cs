...
public class InitializerSourceGeneratorTests
{
    ...
    public Task Should_Report_Skip_Diagnostics_Details()
    {
        var scenarios = new[]
        {
            new SkipScenario("LanguageTooLow", LanguageVersion.CSharp8, GetReferences(typeof(ModuleInitializerAttribute)), ["AutoGenerateNsisPluginInitializer=true"]),
            new SkipScenario("MissingModuleInitializerAttribute", LanguageVersion.CSharp9, null, ["AutoGenerateNsisPluginInitializer=true"]),
            new SkipScenario("AutoGenerateDisabled", LanguageVersion.CSharp14, GetReferences(typeof(ModuleInitializerAttribute)), ["AutoGenerateNsisPluginInitializer=false"])
        };
